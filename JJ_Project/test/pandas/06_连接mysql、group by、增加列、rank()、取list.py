...
print("-----df1------")
offline = select_offline(conn)
df1 = pd.DataFrame(offline,columns=['user_id', 'earliest_ts'])
print(df1['earliest_ts'].dtypes)
print(df1)

print("------df2-------")
realtime = select_realtime(conn)
df2 = pd.DataFrame(realtime,columns=['user_id', 'data_ts'])
